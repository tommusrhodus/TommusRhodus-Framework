...
class Widget_TommusRhodus_Video_Lightbox_Block extends Widget_Base {
	...
	protected function render() {
		...
		if( 'inline-local' == $settings['layout'] ) {
			...
			echo '
				<div>
              		<div class="player" data-plyr-provider="vimeo" data-plyr-embed-id="'. $settings['video_url'] .'"></div>
            	</div>
			';	
			...
			echo '
				<div>
              		<div class="player" data-plyr-provider="youtube" data-plyr-embed-id="'. $settings['video_url'] .'"></div>
            	</div>	
			';	
